...
// independent recomputation, not a wrapper around any SDK, so a pass here
// cross-checks the hashes in vectors.json against a second implementation.
// The Python sibling (verify.py) is a third, in another language.
//
